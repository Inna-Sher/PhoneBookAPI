...
public class TestConfig {
    ...
    public static  final MediaType JSON =
            MediaType.get("application/json; charset=utf-8"); // Создание статической константы JSON, которая представляет собой объект MediaType. В данном случае устанавливается тип контента application/json с кодировкой utf-8.
